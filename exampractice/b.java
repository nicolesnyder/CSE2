...
public class b{ //define the class
    public static void main(String[] args){ //ad a main method
        ...
        if (correctLength){                         //follows this if the input is correct
            ...
            if(c == 11- (sum % 11) && !wrongDigits){          //if d is equal to the check digit
                System.out.println("This is a valid ISBN.");
            }
            else if (c != 11 - (sum % 11) && !wrongDigits){       //if d doesn't equal the check digit
                if (11 - (sum%11) == 10){                         //if d doesn't equal the check digit and the check digit is equal to 10, then X must be printed instead of 10
